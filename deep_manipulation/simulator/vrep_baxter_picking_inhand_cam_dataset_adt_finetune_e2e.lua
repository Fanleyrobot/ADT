...
args.dataset = 'image300_sim_data_3000.t7' -- perception sim dataset
...
args.real_dataset = 'image300_real_data_186.t7' -- perception unlabelled real dataset

args.extra_dataset = 'image300_real_data_93.t7' -- perception labelled real dataset
-- args.extra_dataset = 'table_top_blue_box_dataset_dr_constrained0.05_0.t7'

-- local folder = "/run/user/1000/gvfs/smb-share:server=hpc-fs.qut.edu.au,share=n9314181/deepmind/acrv_deep_mind/modular_drm/"
-- local folder = "/run/user/1000/gvfs/smb-share:server=hpc-fs.qut.edu.au,share=work/cyphy/Fangyi/DeepManipulation/18.CoRL_RA-L/dataset/datasets_for_ICRA2018/control/used_one/0.03/"
-- args.e2e_dataset = folder .. 'image300_control_dataset_off_vel0.03_0.t7' -- end-to-end dataset

args.e2e_dataset = 'image300_control_dataset_333.t7' -- end-to-end dataset

-- args.e2e_real_dataset = 'sorted_image300_real_data_12.t7'
