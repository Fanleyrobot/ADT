--[[ File
@description:
    This class is for constructing a real franka manipulator emtry.
@version: V0.00
...
@history:
    V0.00   27/09/2018  developed the first version
]]
...
-- args.inter_class = "franka_vel" -- or "baxter_vel"
-- args.inter_class = "baxter_vel"
args.e2e_mode = true
-- args.e2e_mode = false
args.RL_mode = false
...
args.joint_pose_max = {2.8973, 1.7628, 2.8973, -0.0698, 2.8973, 3.7525, 2.8973}
args.joint_pose_min = {-2.8973, -1.7628, -2.8973, -3.0718, -2.8973, -0.0175, -2.8973}
args.left_arm_init_pose = {-1.29, -0.26, -0.27, -2.34, 0.12, 2.10, 0.48}
